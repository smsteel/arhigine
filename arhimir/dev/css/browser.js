...
(function($) {
    $.reject = function(opts) {
        var opts = $.extend(true,{
            ...
            header: 'А вы знаете, что Ваш браузер уже морально устарел?', // Header of pop-up window
            paragraph1: 'Он устарел и не совместим с нашим сайтом. Вы можете выбрать и скачать современный браузер из списка:', // Paragraph 1
            paragraph2: 'Кликните по иконке, чтобы перейти на страницу загрузки', // Paragraph 2
            close: true, // Allow closing of window
            closeMessage: 'Вы можете проигнорировать это сообщение, и продолжить просмотр в Вашем текущем браузере', // Message displayed below closing link
